...
const Hero = () => {
  return (
    <menu className='flex lg:mt-20 flex-col lg:flex-row items-center justify-between min-h-[calc(90vh-6rem)]'>
        ...
        {/*tag box with gradient border*/}
          ...
          <p className='text-base sm:text-lg tracking-wider text-gray-400 max-w-[25rem] lg:max-w-[30rem]'>
            the best way to reach uumans of span folderst, dlever transitional and marketing emails at scale.
          </p>
